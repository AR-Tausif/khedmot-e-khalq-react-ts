...
import FilterSuitDateBtn from "@/components/shared/FilterSuitDateBtn";
  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden py-0">
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:pt-24">
          <div className="text-center">
            <h1 className="text-4xl sm:text-6xl font-bold text-red-600 dark:text-gray-200">
              Khedmot-E-Khalq-BD
            </h1>
            <p className="mt-3 text-gray-600 dark:text-gray-400">
              Crafted by Khedmot E Khalq Bangladesh.
            </p>
            <div className="mt-7 sm:mt-12 mx-auto max-w-xl relative">
              ...
              <FilterSuitDateBtn setDonors={setDonors} />
              {/* End Form */}
              {/* SVG Element */}
      ...
      <div>
        <MeetOurDonors donors={donors} setDonors={setDonors} />
      </div>
