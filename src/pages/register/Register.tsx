...
const Register = () => {
  return (
    <div className="min-w-screen min-h-screen bg-blue-50 flex items-center justify-center px-5 py-5">
      <div
        className="bg-gray-50 text-blue-50 rounded-3xl shadow-xl w-full overflow-hidden"
        style={{ maxWidth: 1000 }}
      >
