const Navbar = () => {
  return (
    <nav className=" bg-white w-full flex relative xl:hidden md:hidden lg:hidden justify-between items-center mx-auto px-8 h-14">
      {/* logo */}

      {/* end logo */}
      {/* search bar */}
      <div className="hidden sm:block flex-shrink flex-grow-0 justify-start px-2">
        <div className="inline-block sr-only">here was search button</div>
      </div>
      {/* end search bar */}
      {/* login */}
