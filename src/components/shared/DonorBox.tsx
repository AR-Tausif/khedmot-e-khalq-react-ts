import { LocateIcon, MapPin, Syringe } from "lucide-react";
import React from "react";

const DonorBox = ({ donor }) => {
  return (
      ...
      <div className="flex items-center gap-x-4">
        ...
        <div className="grow">
          ...
          <p className="text-xs  text-gray-500">
            Donated <span className="text-gray-500">37 days ago</span>
          </p>
        </div>
      </div>
      <p className="mt-3 text-sm flex items-center gap-2 text-red-500">
        <Syringe size={17} fill="red" /> <span>{donor.bloodType}</span>
      </p>
      <p className="mt-3 text-sm flex items-center gap-2 text-gray-500">
        <MapPin size={17} /> <span>{donor.address}</span>
      </p>
      {/* Social Brands */}
